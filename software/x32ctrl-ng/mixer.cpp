...
// #endif
    ...
    helper->Debug("END ############# InitMixer() ############# END \n\n");
...
void Mixer::FaderMoved(SurfaceEvent* event){
    ...
    if (activeBankMode == X32_SURFACE_MODE_BANKING_X32) {
        ...
        SetVolume(vchannelIndex, helper->Fader2dBfs(event->value));
...
void Mixer::ButtonPressed(SurfaceEvent* event) {
        ...
        if (buttonPressed){
            switch (button) {
                ...
                case X32_BTN_BOARD_L_CH_8_SOLO:
                    ToggleSolo(GetvChannelIndexFromButtonOrFaderIndex(event->boardId, button - X32_BTN_BOARD_L_CH_1_SOLO));
                    break;
                ...
                case X32_BTN_BOARD_M_CH_8_SOLO:
                    ToggleSolo(GetvChannelIndexFromButtonOrFaderIndex(event->boardId, button - X32_BTN_BOARD_M_CH_1_SOLO));
                    break;
                ...
                case X32_BTN_MAIN_SOLO:
                    ToggleSolo(GetvChannelIndexFromButtonOrFaderIndex(event->boardId, button - X32_BTN_BOARD_R_CH_1_SOLO));
                    break;
                ...
                case X32_BTN_BOARD_L_CH_8_MUTE:
                    ToggleMute(GetvChannelIndexFromButtonOrFaderIndex(event->boardId, button - X32_BTN_BOARD_L_CH_1_MUTE));
                    break;
                ...
                case X32_BTN_BOARD_M_CH_8_MUTE:
                    ToggleMute(GetvChannelIndexFromButtonOrFaderIndex(event->boardId, button - X32_BTN_BOARD_M_CH_1_MUTE));
                    break;
                ...
                case X32_BTN_MAIN_MUTE:
                    ToggleMute(GetvChannelIndexFromButtonOrFaderIndex(event->boardId, button - X32_BTN_BOARD_R_CH_1_MUTE));
                    break;
...
void Mixer::EncoderTurned(SurfaceEvent* event) {
...
void Mixer::guiSync(void) {
    ...
    //####################################
        ...
        for(int i=0; i<=15; i++){
            ...
            switch (i){
                case 0:
                    lv_slider_set_value(objects.slider01, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 1:
                    lv_slider_set_value(objects.slider02, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 2:
                    lv_slider_set_value(objects.slider03, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 3:
                    lv_slider_set_value(objects.slider04, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 4:
                    lv_slider_set_value(objects.slider05, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 5:
                    lv_slider_set_value(objects.slider06, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 6:
                    lv_slider_set_value(objects.slider07, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 7:
                    lv_slider_set_value(objects.slider08, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 8:
                    lv_slider_set_value(objects.slider09, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 9:
                    lv_slider_set_value(objects.slider10, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 10:
                    lv_slider_set_value(objects.slider11, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 11:
                    lv_slider_set_value(objects.slider12, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 12:
                    lv_slider_set_value(objects.slider13, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 13:
                    lv_slider_set_value(objects.slider14, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 14:
                    lv_slider_set_value(objects.slider15, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
                case 15:
                    lv_slider_set_value(objects.slider16, helper->Dbfs2Fader(dsp.dspChannel[chan.index].volumeLR), LV_ANIM_OFF);
                    break;
            }
        }
...
void Mixer::surfaceSyncBoardMain() {
    ...
    if (needForSync){
        if (config->IsModelX32FullOrCompactOrProducer()){
            ...
            if (fullSync || chan.HasChanged(X32_VCHANNEL_CHANGED_PHANTOM)){
                surface->SetLedByEnum(X32_BTN_PHANTOM_48V, halGetPhantomPower(chan.index)); 
            }
            if (fullSync || chan.HasChanged(X32_VCHANNEL_CHANGED_PHASE_INVERT)){
                surface->SetLedByEnum(X32_BTN_PHASE_INVERT, halGetPhaseInvert(chan.index));
            }
        ...
        if (config->IsModelX32Rack()){
            ...
            if (fullSync || chan.HasChanged(X32_VCHANNEL_CHANGED_SOLO)){
                helper->Debug(" Solo");
                surface->SetLedByEnum(X32_BTN_CHANNEL_SOLO, halGetSolo(chan.index)); 
            }
            if (fullSync || chan.HasChanged(X32_VCHANNEL_CHANGED_MUTE)){
                helper->Debug(" Mute");
                surface->SetLedByEnum(X32_BTN_CHANNEL_MUTE, halGetMute(chan.index)); 
            }
            if (fullSync || chan.HasChanged(X32_VCHANNEL_CHANGED_VOLUME)){
                // u_int16_t faderVolume = helper->Dbfs2Fader(halGetVolume(chan.index));
    ...
    // Clear Solo
    if (HasChanged(X32_MIXER_CHANGED_VCHANNEL)){ surface->SetLedByEnum(X32_BTN_CLEAR_SOLO, IsSoloActivated()); }
}
    ...
    for(int i=0; i<=maxChannel; i++){
        ...
        if (channelIndex == VCHANNEL_NOT_SET) {
            ...
            if (fullSync || chan.HasAnyChanged()){
                helper->Debug("syncronize channel%d: %s -", channelIndex, chan.name);
