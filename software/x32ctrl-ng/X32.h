...
#define size_Xauxin 114
#define size_Xnode 232
#define size_Xbus 99
#define size_Xconfig 336
#define size_Xchannel 160
#define size_Xdca 57
#define size_Xfx 71
#define size_Xfxrtn 110
#define size_Xheadamp 4
#define size_Xurec 219
#define size_Xprefs 241
#define size_Xaction 30
#define size_Xstat 147
#define size_Xoutput 301
#define size_Xlibsc 602
#define size_Xlibsr 601
#define size_Xlibs 601
#define size_Xsnippet 701
#define size_Xshow 6016
#define size_Xscene 501
#define size_Xmtx 69
#define size_Xmisc 311
#define size_Xmain 182
...
class X32header {	// The Header structure is used to quickly scan through
	public:
...
};				// dedicated function pointer call

class X32command {	// The Command structure describes ALL X32 commands
	public:
		const char* command;			// - Their syntax (/ch/01/config/icon (for example))
		union ft {					// - Their format type (no data, int, float, string, blob, special type...)
		...
		union val {					// - The value associated to the format type above
		...
		X32command();
		X32command(const char* c, ft f, int fl, val v, const char* *n){
			this->command = c;
			this->format = f;
			this->flags = fl;
			this->value = v;
...
class X32enum {	// X32 enum structure
	public:
		char*	str;			// X32 enum name
		int		ival;			// X32 corresponding int value
};

class X32node {	// The Node header structure is used to directly
	public:
		const char* command;			// parse a node command on a limited number of characters and
		int nchars;				// "jump" to the associated node entry function to manage
		X32command** cmd_ptr;	// the appropriate "node ,s ..." answer
		int cmd_max;			//

		X32node();
		X32node(const char* c, int n, X32command* cpp, int m){
			this->command = c;
			this->nchars = n;
			this->cmd_ptr = &cpp; // TODO: just for compiling, does not work!
			this->cmd_max = m;
		}
		X32node(const char* c, int n, X32command** cpp, int m){
			this->command = c;
...
class X32 {
	...
	private:
		...
		X32command* Xmisc[size_Xmisc];
		X32command* Xshow[size_Xshow];
		X32command* Xconfig[size_Xconfig];
		X32command* Xmain[size_Xmain];

		X32node* Xnode[size_Xnode];
		
		void construct_xmisc();
		void construct_xshow();
		void construct_xconfig();
		void construct_xmain();

		void construct_xnode();
	...
	public:
		...
		int Xfprint(char *bd, int index, const char* text, char format, void *bs);
...
const char*	OffOn[3] = {" OFF", " ON", ""};
const char* Xamxgrp[4] = {" OFF", " X", " Y", ""};
const char* Xcolors[17] = {" OFF", " RD", " GN", " YE", " BL", " MG", " CY", " WH", " OFFi", " RDi", " GNi", " YEi", " BLi", " MGi", " CYi", " WHi", ""};
const char* XSsourc[8] = {" OFF", " LR", " LR+C", " LRPFL", " LRAFL", " AUX56", " AUX78", ""};
const char* Xmnmode[3] = {" LR+M", " LCR", ""};
const char* Xchmode[3] = {" PFL", " AFL", ""};
const char*  Xhslop[4] = {" 12", " 18", " 24", ""};
const char*  Xgmode[6] = {" EXP2", " EXP3", " EXP", " GATE", " DUCK", ""};
const char* Xdymode[3] = {" COMP", " EXP", ""};
const char*  Xdydet[3] = {" PEAK", " RMS", ""};
const char*  Xdyenv[3] = {" LIN", " LOG", ""};
const char*  Xdyrat[13] = {" 1.1", " 1.3", " 1.5", " 2.0", " 2.5", " 3.0", " 4.0", " 5.0", " 7.0", " 10", " 20", " 100", ""};
const char* Xdyftyp[10] = {" LC6", " LC12", " HC6", " HC12", " 1.0", " 2.0", " 3.0", " 5.0", " 10.0", ""};
const char* Xdyppos[3] = {" PRE", " POST", ""};
const char*   Xisel[24] = {" OFF", " FX1L", " FX1R", " FX2L", " FX2R", " FX3L", " FX3R",
				" FX4L", " FX4R", " FX5L", " FX5R", " FX6L", " FX6R", " FX7L",
				" FX7R", " FX8L", " FX8R", " AUX1", " AUX2", " AUX3", " AUX4",
				" AUX5", " AUX6", ""};
const char*  Xeqty1[7] = {" LCut", " LShv", " PEQ", " VEQ", " HShv", " HCut", ""};
const char*  Xeqty2[15] = {" LCut", " LShv", " PEQ", " VEQ", " HShv", " HCut", " BU6",
				" BU12", " BS12", " LR12", " BU18", " BU24", " BS24", " LR24", ""};
const char*  Xmtype[7] = {" IN/LC", " <-EQ", " EQ->", " PRE", " POST", " GRP", ""};
const char* XTsourc[3] = {" INT", " EXT", ""};
const char* XOscsel[3] = {" F1", " F2", ""};
const char* XOsctyp[4] = {" SINE", " PINK", " WHITE", ""};
const char*  XCFrsw[3] = {" REC", " PLAY", ""};
const char*  XRtgin[21] = {" AN1-8", " AN9-16", " AN17-24", " AN25-32", " A1-8", " A9-16", " A17-24", " A25-32", " A33-40",
				" A41-48", " B1-8", " B9-16", " B17-24",	" B25-32", " B33-40", " B41-48", " CARD1-8", " CARD9-16",
				" CARD17-24", " CARD25-32", ""};
const char*  XRtaea[27] = {" AN1-8", " AN9-16", "AN17-24", " AN25-32", " A1-8",	" A9-16", " A17-24", " A25-32", " A33-40",
				" A41-48", " B1-8", " B9-16", " B17-24",	" B25-32", " B33-40", " B41-48", " CARD1-8", " CARD9-16",
				" CARD17-24", " CARD25-32", " OUT1-8", " OUT9-16", " P161-8", " P169-16", " AUX1-6/Mon", " AuxIN1-6/TB", ""};
const char*  XRtina[14] = {" AUX1-4", " AN1-2", " AN1-4", " AN1-6", " A1-2", " A1-4", " A1-6",
				" B1-2", " B1-4", " B1-6", " CARD1-2", " CARD1-4", " CARD1-6", ""};
const char*  XRout1[28] = {" AN1-4", " AN9-12", " AN17-20", " AN25-28", " A1-4", " A9-12", " A17-20", " A25-28", " A33-36",
...
const char*  XRout5[27] = {" AN5-8", " AN13-16", " AN21-24", " AN29-32", " A5-8", " A13-16", " A21-24", " A29-32", " A37-40",
...
const char* Sfxtyp1[62] = {" HALL", " AMBI", " RPLT", " ROOM", " CHAM", " PLAT", " VREV", " VRM",
...
const char* Sfxtyp2[35] = {" GEQ2", " TEQ2", " GEQ", " TEQ", " DES2", " DES", " P1A", " P1A2" ,
...
const char*  Sfxsrc[20] = {" INS", " MIX1", " MIX2", " MIX3", " MIX4", " MIX5", " MIX6", " MIX7",
				" MIX8", " MIX9", " MIX10", " MIX11", " MIX12", " MIX13", " MIX14",
				" MIX15", " MIX16", " M/C", ""};

const char*   Xotpos[10] = {"IN/LC", "IN/LC+M", "<-EQ", "<-EQ+M", "EQ->", "EQ->+M", "PRE", "PRE+M", "POST", ""};

const char*  XiQgrp[4] = {" OFF", " A", " B", ""};
const char*  XiQspk[8] = {" none", " iQ8", " iQ10", " iQ12", " iQ15", " iQ15B", " iQ18B", ""};
const char*   XiQeq[7] = {" Linear", " Live", " Speech", " Playback", " User", ""};
const char* Psource[5] = {" INT", " AES50A", " AES50B", " Exp Card", ""};
const char*  PSCont[4] = {" CUES", " SCENES", " SNIPPETS", ""};
const char*   PRpro[4] = {" MC", " HUI", " CC", ""};
const char*  PRrate[3] = {" 48K", " 44K1", ""};
const char*   PRpos[3] = {" PRE", " POST", ""};
const char*  PRmode[3] = {" BAR", " SPEC", ""};
const char*   PRdet[3] = {" RMS", " PEAK", ""};
const char*  PRport[5] = {" MIDI", " CARD", " RTP", ""};
const char*  Pctype[7] = {" FW", " USB", " unk", " unk", " unk", " unk", ""};
const char* Pusbmod[7] = {" 32/32", " 16/16", " 32/8", " 8/32", " 8/8", " 2/2", ""};
const char* Pufmode[5] = {" 32/32", " 16/16", " 32/8", " 8/32", ""};
const char*    Pcaw[3] = {" IN", " OUT", ""};
const char*    Pcas[6] = {" WC", " ADAT1", " ADAT2", " ADAT3", " ADAT4", ""};
const char* Pmdmode[3] = {" 56", " 64", ""};
const char*  Pcmadi[6] = {" 1-32", " 9-40", " 17-48", " 25-56", " 33-64", ""};
const char*  Pcmado[7] = {" OFF", "1-32", " 9-40", " 17-48", " 25-56", " 33-64", ""};
const char* Pmadsrc[5] = {" OFF", " OPT", " COAX", " BOTH", ""};
const char* Purectk[4] = {" 32Ch", " 16Ch", " 8Ch", ""};
const char* Purplbk[3] = {" SD", " USB", ""};
const char* Pursdsl[3] = {" SD1", " SD2", ""};
const char* Purrctl[3] = {" USB", " XLIVE", ""};
const char* Pinvmut[3] = {" NORM", " INV", ""};
const char* Pclkmod[3] = {" 24h", " 12h", ""};
const char* Purerpa[4] = {" REC", " PLAY", " AUTO", ""};
const char* Prtavis[14] = {" OFF", " 25%", " 30%", " 35%", " 40%", "45%", "50%", " 55%",
						" 60%", "65%", "70%", "75%", "80%", ""};
const char*  Prtaph[10] = {" OFF", " 1", " 2", " 3", " 4", "5", "6", " 7", "8", ""};
const char*    Ubat[4] = {" NONE", " GOOD", " LOW", ""};
const char*    Usdc[5] = {" NONE", " READY", " PROTECT", " ERROR", ""};

const char* Sselidx[73] = {" Ch01", " Ch02", " Ch03", " Ch04", " Ch05", " Ch06", " Ch07", " Ch08",
...
const char*	Sscrn[12] = {" CHAN", " METERS", " ROUTE", " SETUP", " LIB", " FX",
				" MON", " USB", " SCENE", " ASSIGN", " LOCK", ""};
const char*	Schal[8] = {" HOME", " CONFIG", " GATE", " DYN", " EQ", "MIX", " MAIN", ""};
const char*	Smetl[6] = {" CHANNEL", " MIXBUS", " AUX/FX", " IN/OUT", " RTA", ""};
const char*	Sroul[9] = {" HOME", " AES50A", " AES50B", " CARDOUT", "XLROUT", " ANAOUT", "AUXOUT", "P16OUT", "USER"};
const char*	Ssetl[8] = {" GLOB", " CONF", " REMOTE", " NETW", "NAMES", "PREAMPS", " CARD", ""};
const char*	Slibl[4] = {" CHAN", " EFFECT", " ROUTE", ""};
const char*	 Sfxl[10] = {" HOME", " FX1", " FX2", " FX3", "FX4", "FX5", " FX6", " FX7", " FX8", ""};
const char*	Smonl[5] = {" MONITOR", " TALKA", " TALKB", " OSC", ""};
const char*	Susbl[3] = {" HOME", " CONFIG", ""};
const char*	Sscel[7] = {" HOME", " SCENES", " BITS", " PARSAFE", "CHNSAFE", "MIDI", ""};
const char*	Sassl[5] = {" HOME", " SETA", " SETB", " SETC", ""};
const char*	Stapl[8] = {" STOP", " PPAUSE", " PLAY", " RPAUSE", "RECORD", "FF", "REW", ""};

const char* R00[3] = {"OFF", "ON", ""};
const char* R01[3] = {"FRONT", "REAR", ""};
const char* R02[3] = {"ST", "M/S", ""};
const char* R03[6] = {"2", "8", "12", "20", "ALL", ""};
const char* R04[3] = {"COMP", "LIM", ""};
const char* R05[4] = {"GR", "SBC", "PEAK", ""};
const char* R06[3] = {"0", "1", ""};
const char* R07[7] = {"OFF", "Bd1", "Bd2", "Bd3", "Bd4", "Bd5", ""};
const char* R08[3] = {"12", "48", ""};
const char* R09[15] = {"1.1", "1.2", "1.3", "1.5", "1.7", "2", "2.5", "3", "3.5", "4", "5", "7", "10", "LIM", ""};
const char* R10[6] = {"1k5", "2k", "3k", "4k", "5k", ""};
const char* R11[12] = {"200", "300", "500", "700", "1k", "1k5", "2k", "3k", "4k", "5k", "7k", ""};
const char* R12[6] = {"200", "300", "500", "700", "1000", ""};
const char* R13[4] = {"5k", "10k", "20k", ""};
const char* R14[8] = {"3k", "4k", "5k", "8k", "10k", "12k", "16k", ""};
const char* R15[5] = {"20", "30", "60", "100", ""};
const char* R16[3] = {"FEM", "MALE", ""};
const char* R17[4] = {"AMB", "CLUB", "HALL", ""};
const char* R18[3] = {"PAR", "SER", ""};
const char* R19[5] = {"1", "1/2", "2/3", "3/2", ""};
const char* R20[15] = {"1/4", "1/3", "3/8", "1/2", "2/3", "3/4", "1", "1/4X", "1/3X", "3/8X", "1/2X", "2/3X", "3/4X", "1X",""};
const char* R21[4] = {"LO", "MID", "HI",""};
const char* R22[8] = {"TRI", "SIN", "SAW", "SAW-", "RMP", "SQU", "RND",""};
const char* R23[5] = {"LP", "HP", "BP", "NO",""};
const char* R24[3] = {"M", "ST",""};
const char* R25[22] = {"1/4", "3/8", "1/2", "2/3", "1", "4/3", "3/2", "2", "3",""};
const char* R26[3] = {"2POL", "4POL",""};
const char* R27[3] = {"RUN", "STOP",""};
const char* R28[3] = {"SLOW", "FAST",""};
const char* R29[3] = {"ST", "MS",""};


const char*    	Ssource[7] = {" OFF", " LR", " LR+C", " LRPFL", " LRAFL", " AUX56", " AUX78"};
const char*    	Sosct[3] =	{" SINE", " PINK", " WHITE"};
const char*		Sroutin[20] = {" AN1-8", " AN9-16", " AN17-24", " AN25-32",
						" A1-8", " A9-16", " A17-24", " A25-32", " A33-40", " A41-48",
						" B1-8", " B9-16", " B17-24", " B25-32", " B33-40", " B41-48",
						" CARD1-8", " CARD9-16", " CARD17-24", " CARD25-32"};

const char*		Sroutax[13] = {" AUX1-4", " AN1-2", " AN1-4", " AN1-6",
						" A1-2", " A1-4", " A1-6", " B1-2", " B1-4", " B1-6",
						" CARD1-2", "CARD1-4", "CARD1-6"};

const char*		Sroutac[26] = {" AN1-8", " AN9-16", " AN17-24", " AN25-32",
						" A1-8", " A9-16", " A17-24", " A25-32", " A33-40", " A41-48",
						" B1-8", " B9-16", " B17-24", " B25-32", " B33-40", " B41-48",
						" CARD1-8", " CARD9-16", " CARD17-24", " CARD25-32",
						" OUT1-8", " OUT9-16", " P161-8", " P169-16", " AUX1-6/Mon", " AuxIN1-6/TB"};

const char*		Srouto1[26] = {" AN1-4", " AN9-12", " AN17-20", " AN25-28",
...
const char*		Srouto2[26] = {" AN5-8", " AN13-16", " AN21-24", " AN29-32",
...
const char*		Scolor[16] = {" OFF", " RD", " GN", " YE", " BL", " MG", " CY", " WH",
					   " OFFi", " RDi", " GNi", " YEi", " BLi", " MGi", " CYi", " WHi"};

const char*		Sfslope[3] = {" 12", " 18", " 24"};

const char*		Samix[3] = {" OFF", " X", " Y"};

const char*		Sgmode[5] = {" EXP2", " EXP3", " EXP4", " GATE", " DUCK"};

const char*		Sgftype[9] = {" LC6", " LC12", " HC6", " HC12", " 1.0", " 2.0", " 3.0", " 5.0", " 10.0"};

const char*		Sdmode[2] = {" COMP", " EXP"};
const char*		Sddet[2] = {" PEAK", " RMS"};
const char*		Sdenv[2] = {" LIN", " LOG"};
const char*		Sdratio[12] = {" 1.1", " 1.3", " 1.5", " 2.0", " 2.5", " 3.0", " 4.0", " 5.0", " 7.0",
						 " 10", " 20", " 100"};

const char *		Sinsel[23] = {" OFF", " FX1L", " FX1R", " FX2L", " FX2R", " FX3L", " FX3R", " FX4L", " FX4R",
		" FX5L", " FX5R", " FX6L", " FX6R", " FX7L", " FX7R", " FX8L", " FX8R", " AUX1",
		" AUX2", " AUX3", " AUX4", " AUX5", " AUX6"};

const char*		Sdpos[2] = {" PRE", " POST"};

const char*		Setype[14] = {" Lcut", " LShv", " PEQ", " VEQ", " HShv", " HCut", " BU6",
				" BU12", " BS12", " LR12", " BU18", " BU24", " BS24", " LR24"};

const char*		Sctype[6] = {" IN/LC", " <-EQ", " EQ->", " PRE", " POST", " GRP"};

const char*		Smpos[9] = {" IN/LC", " IN/LC+M", " <-EQ", " <-EQ+M", " EQ->", " EQ->+M", " PRE", " PRE+M", " POST"};

const char* Sfactor[9] = {" 1/4", " 3/8", " 1/2", " 2/3", " 1", " 4/3", " 3/2", " 2", " 3"};

const char* Smode[3] = {" ST", " X", " M"};

const char* Sfmode[4] = {" LP", " HP", " BP", " NO"};

const char* Sfwave[7] = {" TRI", " SIN", " SAW", " SAW-", " RMP", " SQU", " RND"};

const char* Sfrange[3] = {" LO", " MID", " HI"};

const char* Sfpattern[14] = {" 1/4", " 1/3", " 3/8", " 1/2", " 2/3", " 3/4", " 1", " 1/4X", " 1/3X", " 3/8X", " 1/2X", " 2/3X", " 3/4X","1X"};

const char* Sfdtype[3] = {" AMB", " CLUB", " HALL"};

const char* Sfddelay[4] = {" 1", " 1/2", " 2/3", " 3/2"};

const char* Sfplfreq[4] = {" 20", " 30", " 60", " 100"};

const char* Sfpmfreq[7] = {" 3K", " 4K", " 5K", " 8K", " 10K", " 12K", " 16K"};

const char* Sfphfreq[3] = {" 5K", " 10K", " 20K"};

const char* Sfqlfreq[5] = {" 200", " 300", " 500", " 700", " 1000"};

const char* Sfqmfreq[11] = {" 200", " 300", " 500", " 700", " 1k", " 1k5", " 2k", " 3k", " 4k", " 5k", " 7k"};

const char* Sfqhfreq[5] = {" 1k5", " 2k", " 3k", " 4k", " 5k"};

const char* Sflcmb[6] = {" OFF", " Bd1", " Bd2", " Bd3", " Bd4", " Bd5"};

const char* Sfrcmb[14] = {" 1.1", " 1.2", " 1.3", " 1.5", " 1.7", " 2", " 2.5", " 3", " 3.5", " 4", " 5", " 7", " 10", " LIM"};

const char* Sfmcmb[3] = {" GR", " SBC", " PEAK"};

const char* Sfrulc[5] = {" 4", " 8", " 12", " 20", " ALL"};

const char* f201[201] = {" 20.0", " 20.7", " 21.4", " 22.2", " 23.0", " 23.8", " 24.6", " 25.5", " 26.4", " 27.3",
...
const char* f121[121] = {" 20.0", " 21.2", " 22.4", " 23.8", " 25.2", " 26.7", " 28.3", " 29.9", " 31.7", " 33.6",
...
const char* f101[101] = {" 20.0", " 20.6", " 21.2", " 21.9", " 22.5", " 23.2", " 23.9", " 24.7", " 25.4", " 26.2",
...
X32command Xsnippet[size_Xsnippet] = {
...
X32command Xoutput[size_Xoutput] = {
...
X32command Xaction[size_Xaction] = {
...
X32command Xheadamp[size_Xheadamp] = {
...
X32command Xfxrtn01[size_Xfxrtn] = {
...
X32command Xfxrtn02[size_Xfxrtn] = {
		{"/fxrtn",							{BSCO}, F_FND, {0}, NULL},
...
X32command Xfxrtn03[size_Xfxrtn] = {
		{"/fxrtn",							{BSCO}, F_FND, {0}, NULL},
...
X32command Xfxrtn04[size_Xfxrtn] = {
		{"/fxrtn",							{BSCO}, F_FND, {0}, NULL},
...
X32command Xfxrtn05[size_Xfxrtn] = {
		{"/fxrtn",							{BSCO}, F_FND, {0}, NULL},
...
X32command Xfxrtn06[size_Xfxrtn] = {
		{"/fxrtn",							{BSCO}, F_FND, {0}, NULL},
...
X32command Xfxrtn07[size_Xfxrtn] = {
		{"/fxrtn",							{BSCO}, F_FND, {0}, NULL},
...
X32command Xfxrtn08[size_Xfxrtn] = {
		{"/fxrtn",							{BSCO}, F_FND, {0}, NULL},
...
X32command Xchannel01[size_Xchannel] = {
...
X32command Xchannel02[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel03[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel04[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel05[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel06[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel07[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel08[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel09[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel10[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel11[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel12[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel13[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel14[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel15[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel16[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel17[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel18[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel19[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel20[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel21[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel22[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel23[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel24[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel25[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel26[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel27[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel28[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel29[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel30[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel31[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xchannel32[size_Xchannel] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
// ##      ## ##     ##  #######  ##      ## #### ##    ## 
		...
		X32command Xauxin01[size_Xauxin] = {
...
X32command Xauxin02[size_Xauxin] = {
		{"/auxin",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xauxin03[size_Xauxin] = {
		{"/auxin",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xauxin04[size_Xauxin] = {
		{"/auxin",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xauxin05[size_Xauxin] = {
		{"/auxin",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xauxin06[size_Xauxin] = {
		{"/auxin",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xauxin07[size_Xauxin] = {
		{"/auxin",							{CHCO}, F_FND, {0}, NULL},
...
X32command Xauxin08[size_Xauxin] = {
		{"/auxin",							{CHCO}, F_FND, {0}, NULL},
