...
void systemSportInit() {
	...
	*pCPSP0A = ((unsigned int)&audioTx_tcb[0][0][0] + 3); // pointing DMA to desired DMA-chaining-struct
	*pCPSP0B = ((unsigned int)&audioTx_tcb[1][0][0] + 3); // pointing DMA to desired DMA-chaining-struct
