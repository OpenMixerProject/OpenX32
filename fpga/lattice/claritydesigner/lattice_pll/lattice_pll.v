...
/* Module Version: 5.7 */
/* C:\Programme2\Lattice\Diamond\ispfpga\bin\nt64\scuba.exe -w -n lattice_pll -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 16.00 -fclkop 100 -fclkop_tol 0.0 -phasep 0 -fclkos 80 -fclkos_tol 0.0 -fclkos2 50 -fclkos2_tol 0.0 -phases2 0 -phase_cntl STATIC -rst -fb_mode 2 -fdc O:/fpga/lattice/claritydesigner/lattice_pll/lattice_pll.fdc  */
/* Mon Mar 09 22:54:07 2026 */


`timescale 1 ns / 1 ps
module lattice_pll (CLKI, RST, CLKOP, CLKOS, CLKOS2)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOS_t), .PHASESEL1(scuba_vlo), 
        ...
        .CLKOS3(), .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             ...
             /* synthesis FREQUENCY_PIN_CLKOS="80.000000" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 80.000000
