...
/* Module Version: 5.7 */
/* C:\Programme2\Lattice\Diamond\ispfpga\bin\nt64\scuba.exe -w -n lattice_pll -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 16.00 -fclkop 200 -fclkop_tol 0.0 -fclkos 100 -fclkos_tol 0.0 -phases 0 -phase_cntl STATIC -rst -fb_mode 1 -fdc O:/fpga/lattice/claritydesigner/lattice_pll/lattice_pll.fdc  */
/* Thu Feb 26 22:44:25 2026 */


`timescale 1 ns / 1 ps
module lattice_pll (CLKI, RST, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
