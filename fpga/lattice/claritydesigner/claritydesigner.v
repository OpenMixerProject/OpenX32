...
module claritydesigner (aes50_clk_ddr_data, aes50_clk_ddr_dout, aes50_rmii_rxd_datain, 
            aes50_rmii_rxd_q, aes50_rmii_txd_dout, aes50_clk_ddr_clkout, 
            aes50_clk_ddr_refclk, aes50_clk_ddr_reset, aes50_rmii_rxd_clkin, 
            aes50_rmii_rxd_reset, aes50_rmii_rxd_sclk, aes50_rmii_txd_clkout, 
            ...
            lattice_pll_phy_CLKOP, lattice_pll_phy_CLKOS, lattice_pll_phy_RST) /* synthesis sbp_module=true */ ;
    ...
    aes50_rmii_txd aes50_rmii_txd_inst (.dout({aes50_rmii_txd_dout}), .clkout(aes50_rmii_txd_clkout));
